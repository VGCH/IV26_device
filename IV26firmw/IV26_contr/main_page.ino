void handleRoot() {
  ...
  String html = "<html lang=\"ru\"><head><meta charset=\"UTF-8\"><title>Управление индикатором</title>";
  html += "<link href=\"style.css\" rel=\"stylesheet\" type=\"text/css\" />";
  //html +=  js;
  html += "</head><body>";
  html += FPSTR(divcode);
  html += "<h2>Управление индикатором</h2>";
  ...
  html += "<text>Полученные данные:</text><br><br>";
  html += "<div class =\"live\" id=\"data\">"+String(temp_j)+"</div>";
  html += "<br></div></body>";
  html += "<center><br><a href=\"/?page=wlan_config\">Wi-Fi конфигурация</a><br>";
  html += "<a href=\"/?page=send_config\">Настройка MQTT</a><br>";
  html += "<a href=\"/?page=time_config\">Настройка времени</a><br>";
